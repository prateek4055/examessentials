...
export const medicalApps: MedAppData[] = [
  {
    ...
    longDescription: "MedOrtho is an advanced orthopedic learning app built for medical and physiotherapy students. It combines orthopedic special tests, surgical instruments, MCQs, image-based notes, and clinical revision tools into one clean and student-friendly platform. Designed for fast learning and clinical confidence, MedOrtho helps students prepare for MBBS exams, physiotherapy academics, NEET PG, FMGE, and orthopedic clinical postings.",
    logo: medorthoLogo,
    theme: {
      primary: "#1B3A5C",
      primaryLight: "#2A5A8C",
      ...
      gradientVia: "#1E4D7B",
      gradientTo: "#4AADE4",
      heroBg: "linear-gradient(135deg, #F4F7FB 0%, #EBF3FC 50%, #FFFFFF 100%)",
    ...
    features: [
      ...
      { icon: "FileText", title: "Medical Articles & Updates", description: "Educational orthopedic articles, clinical knowledge updates, and student-oriented content" },
    ],
    ...
    highlights: ["700+ Special Tests", "700+ Surgical Instruments", "Topic-wise MCQs & Quizzes", "Image-based Revision Notes"],
    published: true,
    ...
    faqs: [
      ...
      { question: "Is MedOrtho free to download?", answer: "Yes, MedOrtho is free to download on Google Play Store. It is lightweight, ad-supported, and includes options for premium study materials." },
      { question: "Who can benefit from MedOrtho?", answer: "MedOrtho is designed for MBBS students, BPT students, medical interns, orthopedic residents, and candidates preparing for exams like NEET PG, FMGE, and USMLE." },
    ...
    hasWiki: true,
    seo: {
      title: "MedOrtho — Orthopedic Special Tests & Clinical Learning App",
      ...
      keywords: "orthopedic learning app, orthopedic special tests app, MBBS orthopedic app, physiotherapy orthopedic app, orthopedic MCQs, surgical instruments app, orthopedic examination app, musculoskeletal learning app, orthopedic revision notes, orthopedic quiz app",
    },
  },
  {
    id: "medcardio",
    ...
    theme: {
      ...
      gradientVia: "#BE185D",
      gradientTo: "#F472B6",
      heroBg: "linear-gradient(135deg, #FDF2F8 0%, #FCE7F3 50%, #FFFFFF 100%)",
  ...
  },
  {
    ...
    theme: {
      ...
      gradientVia: "#6B21A8",
      gradientTo: "#A855F7",
      heroBg: "linear-gradient(135deg, #FAF5FF 0%, #F3E8FF 50%, #FFFFFF 100%)",
  ...
  },
  {
    ...
    theme: {
      ...
      gradientVia: "#166534",
      gradientTo: "#84CC16",
      heroBg: "linear-gradient(135deg, #F0FDF4 0%, #DCFCE7 50%, #FFFFFF 100%)",
  ...
  },
  {
    ...
    theme: {
      ...
      gradientVia: "#134E4A",
      gradientTo: "#2DD4BF",
      heroBg: "linear-gradient(135deg, #F0FDFA 0%, #CCFBF1 50%, #FFFFFF 100%)",
  ...
  },
  {
    ...
    theme: {
      ...
      gradientVia: "#7C3AED",
      gradientTo: "#F59E0B",
      heroBg: "linear-gradient(135deg, #FAF5FF 0%, #F5F3FF 50%, #FFFFFF 100%)",
